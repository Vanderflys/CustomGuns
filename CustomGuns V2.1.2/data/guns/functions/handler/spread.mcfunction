...
execute store result score @s Raycast run data get entity @s SelectedItem.components."minecraft:custom_data".range 4
execute anchored eyes positioned ^.5 ^.5 ^.5 run function guns:handler/raycast
execute store result score @s Raycast run data get entity @s SelectedItem.components."minecraft:custom_data".range 4
execute anchored eyes positioned ^-.5 ^.5 ^-.5 run function guns:handler/raycast
execute store result score @s Raycast run data get entity @s SelectedItem.components."minecraft:custom_data".range 4
execute anchored eyes positioned ^-.5 ^-.5 ^-.5 run function guns:handler/raycast
...
execute if score .infiniteAmmo Settings matches 0 store result storage guns:stats Magazine int 1 run data get entity @s SelectedItem.components."minecraft:custom_data".magazine
