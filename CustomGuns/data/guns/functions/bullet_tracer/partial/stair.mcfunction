...
execute if block ~ ~ ~ #stairs[facing=north] run function guns:bullet_tracer/partial/transforms/rotate_90
execute if block ~ ~ ~ #stairs[facing=west] run function guns:bullet_tracer/partial/transforms/rotate_180
execute if block ~ ~ ~ #stairs[facing=south] run function guns:bullet_tracer/partial/transforms/rotate_270
